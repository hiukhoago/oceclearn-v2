    ...
    function DateTimePicker(element, options) {
        var picker = {},
            ...
            _createDatePicker = function () {
                ...
                $table.$prevm = _createCell($row, '<i class="icon-datepicker-prev"/>', 2, NAV['prevm'], "prevm");
                //head - tools - title
                $table.$title = $('<td class="title" colspan="3"/>').data('nav', NAV['title']).appendTo($row);
                //head - tools - prev month
                $table.$nextm = _createCell($row, '<i class="icon-datepicker-next"/>', 2, NAV['nextm'], "nextm");
                $row.appendTo($thead);
                //head - week names
                $row = $('<tr/>');
                var i;
