...
?>
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?> cart-collaterals">
	<div class="cart_totals"> 
		
		<?php do_action( 'woocommerce_before_cart_totals' ); ?>

		<table cellspacing="0" class="shop_table cart-total-table">
			
			<tbody>
				<tr class="cart-subtotal first">
					<th><?php _e( 'SubTotal (Tax Incl.)', 'woocommerce' ); ?></th>
					<td data-title="<?php esc_attr_e( 'SubTotal', 'woocommerce' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
				</tr>

				<?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
					<tr class="fee coupon-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
