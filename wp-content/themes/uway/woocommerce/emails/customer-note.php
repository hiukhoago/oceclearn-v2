...
<div style="line-height: 24px;font-size: 16px;font-weight: 300; letter-spacing: 0.2px;color:#020202;font-family:'Futura', Helvetica, Arial, sans-serif; padding-right: 15px; padding-left: 15px; padding-top: 10px; padding-bottom: 30px;">
    ...
    <div style="color:#000;font-family:'Futura', Helvetica, Arial, sans-serif;font-weight: 300; max-width: 500px; margin: 0 auto;text-align: center;letter-spacing: 0.2px;">
    	<p style="color:#000;"><?php printf( esc_html__( 'Hi %s,', 'woocommerce' ), esc_html( $order->get_billing_first_name() ) ); ?></p>
        <p style="color:#000;"><?php esc_html_e( 'The following note has been added to your order:', 'woocommerce' ); ?></p>
		...
		<p style="color:#000;"><?php esc_html_e( 'As a reminder, here are your order details:', 'woocommerce' ); ?></p>
    </div>
